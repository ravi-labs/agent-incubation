...
# These three deps are still in foundry — they migrate as modules 6, 9, and
# the tollgate-vendored cleanup respectively. Switch to native arc imports
# once they land. See docs/migration-plan.md.
