...
from foundry.integrations.langgraph import END, START, FoundryState, GraphAgent
...
async def _run_sandbox(fund_id: str = "FUND001", plan_id: str = "PLAN001") -> None:
    ...
    from foundry.scaffold.manifest import AgentManifest
    from foundry.tollgate.tower import ControlTower
    from foundry.tollgate import AutoApprover, JsonlAuditSink, YamlPolicyEvaluator
    from foundry.gateway.base import GatewayConnector
    from foundry.observability.tracker import OutcomeTracker
