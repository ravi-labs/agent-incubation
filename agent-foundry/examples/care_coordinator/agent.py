...
Demonstrates agent-foundry governance using HealthcareEffect (HIPAA taxonomy).
...
async def main():
    print("=" * 60)
    print("Care Coordinator Agent — agent-foundry demo")
    ...
    print("Generate HTML report: foundry-audit care_coordinator_audit.jsonl")
