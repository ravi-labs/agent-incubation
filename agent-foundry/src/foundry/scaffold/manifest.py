...
Every incubated agent declares its manifest before any code is written.
The manifest defines scope, permissions, success criteria, and lifecycle
stage. It becomes the audit record that proves due diligence was done.
...
Manifest YAML schema:
  ...
  allowed_effects:  List of FinancialEffect values this agent may invoke
