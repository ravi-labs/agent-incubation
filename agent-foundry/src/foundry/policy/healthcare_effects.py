"""
Healthcare Effect Taxonomy for Agent Foundry.
...
from foundry.policy.effects import EffectTier, DefaultDecision, EffectMeta


# Re-use the Tollgate base Effect enum — import lazily to avoid coupling
try:
    from foundry.tollgate.types import Effect as _BaseEffect
except ImportError:
    # Fallback for environments without Tollgate installed
    class _BaseEffect(str, Enum):  # type: ignore[no-redef]
        READ   = "READ"
        WRITE  = "WRITE"
        NOTIFY = "NOTIFY"
        DELETE = "DELETE"
